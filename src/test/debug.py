...
def show_route_data():
    ...
    #with open('../../res/data/20200613/512848/monte_carlo_straight.csv') as f:
    #with open('../../res/data/20200613/512848/td_straight.csv') as f:
    #with open('../../res/data/20200613/316632/td_straight.csv') as f:
    with open('../../res/data/20200613/316632/monte_carlo_straight.csv') as f:
        reader = csv.reader(f)
        for row in reader:
            _route = []
            for r in row:
